...
namespace Digishui.Extensions
{
  //===========================================================================================================================
  /// <summary>
  ///   Extensions for working with Luhn check digits.
  /// </summary>
  /// <remarks>
  ...
  public static class LuhnExtensions
  {
    ...
    {
      return digits.Last() == CheckDigit([.. digits.Take(digits.Count - 1)]);
    }
    ...
    {
      return [.. digits.ToString(CultureInfo.InvariantCulture).Select(d => d - 48)];
    }
