...
namespace Digishui
{
  //===========================================================================================================================
  /// <summary>
  ///   Simple class for logging to debugger with timestamps for each new line. Contents also exposed as string.
  /// </summary>
  public static class DebugLog
  {
    ...
    public static void Write(string value = "", bool forceNewLineFirst = false)
    {
      ...
      string logEntry = (NewLine == true) ? $"[{DateTime.UtcNow:yyyy-MM-dd HH:mm:ss.fffffff}] " : "";
      logEntry += value;
    ...
    public static void Clear()
    {
      ...
      Debug.WriteLine("DebugLog Cleared");
      Debug.WriteLine(new string('-', 80));
      Debug.WriteLine("");
      Archive.Clear();
    }
